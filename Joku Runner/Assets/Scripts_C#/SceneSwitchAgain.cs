...
public class SceneSwitchAgain : MonoBehaviour
{
    ...
    Sama homma SCRIPT C# KOODISKIN PITÄÄ MÄÄRITTÄÄ SE SAMA TOIMINTA, ETTÄ MIKÄ SCENE MENEÄÄN A --> B --> C JA JNE.

    //Tässä on määritetty esim. Menu(A) --Play--> Sandbox (B) --> voi palata takaisinkin <--SandBox2 (C)
    */
